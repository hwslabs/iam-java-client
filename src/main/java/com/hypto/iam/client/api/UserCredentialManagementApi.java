...
public interface UserCredentialManagementApi {
  ...
  Call<Credential> createCredential(
    @retrofit2.http.Path("user_name") String userName, @retrofit2.http.Path("organization_id") String organizationId, @retrofit2.http.Body CreateCredentialRequest createCredentialRequest
  );
  ...
  Call<BaseSuccessResponse> deleteCredential(
    @retrofit2.http.Path("organization_id") String organizationId, @retrofit2.http.Path("user_name") String userName, @retrofit2.http.Path("credential_id") String credentialId
  );
  ...
  Call<CredentialWithoutSecret> updateCredential(
    @retrofit2.http.Path("organization_id") String organizationId, @retrofit2.http.Path("user_name") String userName, @retrofit2.http.Path("credential_id") String credentialId, @retrofit2.http.Body UpdateCredentialRequest updateCredentialRequest
  );
  ...
  @POST("organizations/{organization_id}/users/{user_name}/credentials")
  Call<Credential> createCredential(
    @retrofit2.http.Path("user_name") String userName, @retrofit2.http.Path("organization_id") String organizationId, @retrofit2.http.Body CreateCredentialRequest createCredentialRequest, @retrofit2.http.HeaderMap Map<String, String> headers
  );
  @DELETE("organizations/{organization_id}/users/{user_name}/credentials/{credential_id}")
  Call<BaseSuccessResponse> deleteCredential(
    @retrofit2.http.Path("organization_id") String organizationId, @retrofit2.http.Path("user_name") String userName, @retrofit2.http.Path("credential_id") String credentialId, @retrofit2.http.HeaderMap Map<String, String> headers
  );
  @GET("organizations/{organization_id}/users/{user_name}/credentials/{credential_id}")
  Call<CredentialWithoutSecret> getCredential(
    @retrofit2.http.Path("organization_id") String organizationId, @retrofit2.http.Path("user_name") String userName, @retrofit2.http.Path("credential_id") String credentialId, @retrofit2.http.HeaderMap Map<String, String> headers
  ...
  @PATCH("organizations/{organization_id}/users/{user_name}/credentials/{credential_id}")
  Call<CredentialWithoutSecret> updateCredential(
    @retrofit2.http.Path("organization_id") String organizationId, @retrofit2.http.Path("user_name") String userName, @retrofit2.http.Path("credential_id") String credentialId, @retrofit2.http.Body UpdateCredentialRequest updateCredentialRequest, @retrofit2.http.HeaderMap Map<String, String> headers
  );
}
