...
public interface ResourceManagementApi {
    /**
     * Create a resource name in an organization. Creates a resource name. Access policies can be
     * associated with the instances of these resources. ex - \\\&quot;Wallet\\\&quot; is a resource
     * name in the organization org - \\\&quot;Org#1\\\&quot; and \\\&quot;wallet#1\\\&quot; is the
     * instance of the resource \\\&quot;Wallet\\\&quot;. Policies on which user to access the
     * wallet#1 can be created by the user having privilege to access the resource.
     *
    ...
    Call<Resource> createResource(
            ...
            @retrofit2.http.Body CreateResourceRequest createResourceRequest);
    ...
    /**
     * Get the resource details Gets the resource details associated with the organization
     *
     * @param organizationId (required)
     * @param resourceName (required)
     * @return Call&lt;Resource&gt;
    ...
    /**
     * List Resources List all the resource names in an organization.
     *
     * @param organizationId (required)
    ...
    /**
     * Update a resource Update resource name of the organization
     *
     * @param organizationId (required)
     * @param resourceName (required)
    ...
    Call<Resource> updateResource(
            @retrofit2.http.Path("organization_id") String organizationId,
            @retrofit2.http.Path("resource_name") String resourceName,
            @retrofit2.http.Body UpdateResourceRequest updateResourceRequest);
